/*
  # Fix blog and career post permissions

  1. Security
    - Enable RLS on blog_posts and career_postings tables
    - Add RLS policies for public viewing and author management
    - Add admin management policy for career postings
