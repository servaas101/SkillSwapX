...
CREATE TABLE projects (
  ...
  end TIMESTAMP WITH TIME ZONE, -- end date
...
BEGIN
  ...
  INSERT INTO projects (uid, org, ttl, dsc, skl, bgt, str, end, loc, typ, met)
  VALUES (auth.uid(), v_org, p_ttl, p_dsc, p_skl, p_bgt, p_str, p_end, p_loc, p_typ, p_met)
