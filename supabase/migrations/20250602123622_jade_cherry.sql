/*
  # Add demo user and blog posts
  
  1. Creates demo author user
  2. Sets up author profile
  3. Adds sample blog posts
...
SELECT auth.create_user(
  jsonb_build_object(
    'id', '21e1ffb5-d6dc-47a5-aea9-0f2cd48ef758'::uuid,
    'email', 'demo.author@skillswapx.com',
