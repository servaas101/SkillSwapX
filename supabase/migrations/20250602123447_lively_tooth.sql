/*
  # Fix user creation and add demo content
  
  1. Changes
    - Remove DEFAULT parameter from auth.admin_create_user
    - Clean up existing user/profile before creating new ones
    - Add demo blog posts with proper author
