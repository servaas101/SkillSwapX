/*
  ...
  1. Changes
    - Remove direct user insertion that bypassed auth flow
    - Use auth.admin.create_user() for proper user creation
    - Ensure password hashing and session handling work correctly
    
  2. Security
    - Properly creates user through Supabase auth system
    - Maintains RLS policies
*/

-- First remove any existing demo user to avoid conflicts
