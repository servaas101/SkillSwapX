/*
  # Fix permissions and relationships for blog and careers

  1. Changes
    - Add foreign key constraint for blog_posts.author_id
    - Enable RLS on career_postings and blog_posts tables
    - Add RLS policies for public access to published content
